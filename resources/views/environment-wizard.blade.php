    ...
    <div class="tabs tabs-full">
        ...
        <form onsubmit="installSubmitted()" method="post" action="{{ route('LaravelInstaller::environmentSaveWizard') }}"
            ...
            <div class="tab" id="tab1content">
                ...
                <div class="form-group {{ $errors->has('app_admin_email') ? ' has-error ' : '' }}">
                ...
                <div class="form-group {{ $errors->has('app_env') ? ' has-error ' : '' }}">
                ...
                <div class="form-group {{ $errors->has('log_level') ? ' has-error ' : '' }}">
                    <label for="log_level">
                        {{ trans('installer::messages.environment.wizard.form.log_level_label') }}
                    </label>
            ...
            <div class="tab" id="tab2content">
                ...
                <div class="buttons">
                    <button class="btn button btn-lg" onclick="showApplicationSettings();return false">
            ...
            <div class="tab" id="tab3content">
                <div class="block">
                    <input type="radio" name="appSettingsTabs" id="appSettingsTab0" value="null" checked />
                    <label for="appSettingsTab0">
                        <span>
                ...
                <div class="block">
                    ...
                    <div class="info">
                        <div class="form-group {{ $errors->has('broadcast_driver') ? ' has-error ' : '' }}">
                            <label
                                for="broadcast_driver">{{ trans('installer::messages.environment.wizard.form.app_tabs.broadcasting_label') }}
                                <sup>
                            ...
                            <input type="text" name="broadcast_driver" id="broadcast_driver" value="log"
                                placeholder="{{ trans('installer::messages.environment.wizard.form.app_tabs.broadcasting_placeholder') }}" />
                        ...
                        <div class="form-group {{ $errors->has('cache_driver') ? ' has-error ' : '' }}">
                            <label
                                for="cache_driver">{{ trans('installer::messages.environment.wizard.form.app_tabs.cache_label') }}
                                <sup>
                            ...
                            <input type="text" name="cache_driver" id="cache_driver" value="file"
                                placeholder="{{ trans('installer::messages.environment.wizard.form.app_tabs.cache_placeholder') }}" />
                        ...
                        <div class="form-group {{ $errors->has('session_driver') ? ' has-error ' : '' }}">
                            <label
                                for="session_driver">{{ trans('installer::messages.environment.wizard.form.app_tabs.session_label') }}
                                <sup>
                            ...
                            <input type="text" name="session_driver" id="session_driver" value="file"
                                placeholder="{{ trans('installer::messages.environment.wizard.form.app_tabs.session_placeholder') }}" />
                        ...
                        <div class="form-group {{ $errors->has('queue_driver') ? ' has-error ' : '' }}">
                            <label
                                for="queue_driver">{{ trans('installer::messages.environment.wizard.form.app_tabs.queue_label') }}
                                <sup>
                            ...
                            <input type="text" name="queue_driver" id="queue_driver" value="sync"
                                placeholder="{{ trans('installer::messages.environment.wizard.form.app_tabs.queue_placeholder') }}" />
                    ...
                    <div class="info">
                        <div class="form-group {{ $errors->has('redis_hostname') ? ' has-error ' : '' }}">
                            ...
                            <input type="text" name="redis_hostname" id="redis_hostname" value="127.0.0.1"
                                placeholder="{{ trans('installer::messages.environment.wizard.form.app_tabs.redis_host') }}" />
                        ...
                        <div class="form-group {{ $errors->has('redis_password') ? ' has-error ' : '' }}">
                            <label
                                for="redis_password">{{ trans('installer::messages.environment.wizard.form.app_tabs.redis_password') }}</label>
                            <input type="password" name="redis_password" id="redis_password" value="null"
                                placeholder="{{ trans('installer::messages.environment.wizard.form.app_tabs.redis_password') }}" />
                        ...
                        <div class="form-group {{ $errors->has('redis_port') ? ' has-error ' : '' }}">
                            <label
                                for="redis_port">{{ trans('installer::messages.environment.wizard.form.app_tabs.redis_port') }}</label>
                            <input type="number" name="redis_port" id="redis_port" value="6379"
                                placeholder="{{ trans('installer::messages.environment.wizard.form.app_tabs.redis_port') }}" />
                    ...
                    <div class="info">
                        <div class="form-group {{ $errors->has('mail_driver') ? ' has-error ' : '' }}">
                            ...
                            <input type="text" name="mail_driver" id="mail_driver" value="smtp"
                                placeholder="{{ trans('installer::messages.environment.wizard.form.app_tabs.mail_driver_placeholder') }}" />
                        ...
                        <div class="form-group {{ $errors->has('mail_host') ? ' has-error ' : '' }}">
                            <label
                                for="mail_host">{{ trans('installer::messages.environment.wizard.form.app_tabs.mail_host_label') }}</label>
                            <input type="text" name="mail_host" id="mail_host" value="smtp.mailtrap.io"
                                placeholder="{{ trans('installer::messages.environment.wizard.form.app_tabs.mail_host_placeholder') }}" />
                        ...
                        <div class="form-group {{ $errors->has('mail_port') ? ' has-error ' : '' }}">
                            <label
                                for="mail_port">{{ trans('installer::messages.environment.wizard.form.app_tabs.mail_port_label') }}</label>
                            <input type="number" name="mail_port" id="mail_port" value="2525"
                                placeholder="{{ trans('installer::messages.environment.wizard.form.app_tabs.mail_port_placeholder') }}" />
                        ...
                        <div class="form-group {{ $errors->has('mail_username') ? ' has-error ' : '' }}">
                            <label
                                for="mail_username">{{ trans('installer::messages.environment.wizard.form.app_tabs.mail_username_label') }}</label>
                            <input type="text" name="mail_username" id="mail_username" value="null"
                                placeholder="{{ trans('installer::messages.environment.wizard.form.app_tabs.mail_username_placeholder') }}" />
                        ...
                        <div class="form-group {{ $errors->has('mail_password') ? ' has-error ' : '' }}">
                            <label
                                for="mail_password">{{ trans('installer::messages.environment.wizard.form.app_tabs.mail_password_label') }}</label>
                            <input type="text" name="mail_password" id="mail_password" value="null"
                                placeholder="{{ trans('installer::messages.environment.wizard.form.app_tabs.mail_password_placeholder') }}" />
                        ...
                        <div class="form-group {{ $errors->has('mail_encryption') ? ' has-error ' : '' }}">
                            <label
                                for="mail_encryption">{{ trans('installer::messages.environment.wizard.form.app_tabs.mail_encryption_label') }}</label>
                            <input type="text" name="mail_encryption" id="mail_encryption" value="null"
                                placeholder="{{ trans('installer::messages.environment.wizard.form.app_tabs.mail_encryption_placeholder') }}" />
                    ...
                    <div class="info">
                        <div class="form-group {{ $errors->has('pusher_app_id') ? ' has-error ' : '' }}">
                            ...
                            <input type="text" name="pusher_app_id" id="pusher_app_id" value=""
                                placeholder="{{ trans('installer::messages.environment.wizard.form.app_tabs.pusher_app_id_palceholder') }}" />
                        ...
                        <div class="form-group {{ $errors->has('pusher_app_key') ? ' has-error ' : '' }}">
                            <label
                                for="pusher_app_key">{{ trans('installer::messages.environment.wizard.form.app_tabs.pusher_app_key_label') }}</label>
                            <input type="text" name="pusher_app_key" id="pusher_app_key" value=""
                                placeholder="{{ trans('installer::messages.environment.wizard.form.app_tabs.pusher_app_key_palceholder') }}" />
                        ...
                        <div class="form-group {{ $errors->has('pusher_app_secret') ? ' has-error ' : '' }}">
                            <label
                                for="pusher_app_secret">{{ trans('installer::messages.environment.wizard.form.app_tabs.pusher_app_secret_label') }}</label>
                            <input type="password" name="pusher_app_secret" id="pusher_app_secret" value=""
                                placeholder="{{ trans('installer::messages.environment.wizard.form.app_tabs.pusher_app_secret_palceholder') }}" />
...
@section('scripts')
    <script type="text/javascript">
        function checkEnvironment(val) {
            var element = document.getElementById('app_env_text_input');
            if (val == 'other') {
