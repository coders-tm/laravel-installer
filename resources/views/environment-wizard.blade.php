            ...
            <div class="tab" id="tab1content">
                ...
                <div class="form-group {{ $errors->has('app_admin_email') ? ' has-error ' : '' }}">
                    <label for="app_admin_email">
                        {{ trans('installer_messages.environment.wizard.form.app_admin_email_label') }}
                    </label>
                ...
                <div class="form-group {{ $errors->has('app_env') ? ' has-error ' : '' }}">
                    <label for="environment">
                        {{ trans('installer_messages.environment.wizard.form.app_env_label') }}
                    </label>
                    <select name="app_env" id="environment" onchange='checkEnvironment(this.value);'>
                        <option value="local" selected>
                            {{ trans('installer_messages.environment.wizard.form.app_env_label_local') }}</option>
                        <option value="development">
                            {{ trans('installer_messages.environment.wizard.form.app_env_label_developement') }}
                        </option>
                        <option value="qa">
                            {{ trans('installer_messages.environment.wizard.form.app_env_label_qa') }}</option>
                        <option value="production">
                            {{ trans('installer_messages.environment.wizard.form.app_env_label_production') }}
                        </option>
                        <option value="other">
                            {{ trans('installer_messages.environment.wizard.form.app_env_label_other') }}</option>
                    </select>
                    <div id="app_env_text_input" style="display: none;">
                        <input type="text" name="app_env_custom" id="app_env_custom"
                            placeholder="{{ trans('installer_messages.environment.wizard.form.app_env_placeholder_other') }}" />
                    </div>
                    @if ($errors->has('app_name'))
                        <span class="error-block">
                            <i class="fa fa-fw fa-exclamation-triangle" aria-hidden="true"></i>
                ...
                <div class="form-group {{ $errors->has('log_level') ? ' has-error ' : '' }}">
                    ...
                    <select name="log_level" id="log_level">
                        <option value="debug" selected>
                            {{ trans('installer_messages.environment.wizard.form.log_level_label_debug') }}</option>
                        <option value="info">
                            {{ trans('installer_messages.environment.wizard.form.log_level_label_info') }}</option>
                        <option value="notice">
                            {{ trans('installer_messages.environment.wizard.form.log_level_label_notice') }}</option>
                        <option value="warning">
                            {{ trans('installer_messages.environment.wizard.form.log_level_label_warning') }}</option>
                        <option value="error">
                            {{ trans('installer_messages.environment.wizard.form.log_level_label_error') }}</option>
                        <option value="critical">
                            {{ trans('installer_messages.environment.wizard.form.log_level_label_critical') }}</option>
                        <option value="alert">
                            {{ trans('installer_messages.environment.wizard.form.log_level_label_alert') }}</option>
                        <option value="emergency">
                            {{ trans('installer_messages.environment.wizard.form.log_level_label_emergency') }}
                        </option>
                    </select>
            ...
            <div class="tab" id="tab3content">
                <div class="block">
                    ...
                    <label for="appSettingsTab1">
                        <span>
                            {{ trans('installer_messages.environment.wizard.form.app_tabs.recaptcha_label') }}
                        </span>
                    </label>
                    <div class="info">
                        <div class="form-group {{ $errors->has('recaptcha_site_key') ? ' has-error ' : '' }}">
                            <label for="recaptcha_site_key">
                                {{ trans('installer_messages.environment.wizard.form.app_tabs.recaptcha_site_key_label') }}
                                <sup>
                            ...
                            <input type="text" name="recaptcha_site_key" id="recaptcha_site_key" value=""
                                placeholder="{{ trans('installer_messages.environment.wizard.form.app_tabs.recaptcha_site_key_palceholder') }}" />
                        ...
                        <div class="form-group {{ $errors->has('recaptcha_secret_key') ? ' has-error ' : '' }}">
                            <label
                                for="recaptcha_secret_key">{{ trans('installer_messages.environment.wizard.form.app_tabs.recaptcha_secret_key_label') }}</label>
                            <input type="text" name="recaptcha_secret_key" id="recaptcha_secret_key" value=""
                                placeholder="{{ trans('installer_messages.environment.wizard.form.app_tabs.recaptcha_secret_key_palceholder') }}" />
